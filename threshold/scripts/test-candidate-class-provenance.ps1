...
try {
    ...
    Assert-True -Condition ($prGovernanceText -match 'Promotion receipt immutable PR base is not ancestor of source base') -Name "PR governance validates source bases against immutable receipt PR base"
