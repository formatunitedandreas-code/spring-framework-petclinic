...
try {
    ...
    Assert-True -Condition ($prGovernanceText -match 'matchingReceiptEntries\.Add\(\$entry\)') -Name "PR governance returns only content-matching promotion receipts"
    ...
    Assert-True -Condition ($prGovernanceText -match 'Promotion squash commit has no content-matching source receipts') -Name "PR governance rejects promotion without content-matching receipts"
